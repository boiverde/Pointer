        ...
        <main className="flex min-h-screen flex-col bg-background text-foreground bg-noise overflow-x-hidden">
            ...
            <section className="relative h-screen w-full flex flex-col justify-center items-center overflow-hidden">
                ...
                <div className="relative z-20 container mx-auto px-6 text-center mt-20">
                    ...
                    <h1 className="text-7xl md:text-9xl lg:text-[11rem] font-black tracking-tight leading-[0.9] mb-8 mix-blend-screen opacity-90 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                        VISTA A <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-b from-white to-neutral-500">GLÓRIA.</span>
                    </h1>

                    <p className="text-lg md:text-2xl text-neutral-400 max-w-2xl mx-auto mb-12 font-medium leading-relaxed tracking-tight animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                        Engenharia de elite. Design atemporal. <br className="hidden md:block" />
                        Os uniformes que definem a história do futebol.
                    </p>

                    <div className="flex flex-col md:flex-row gap-6 justify-center items-center animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                        <Link
                            href="/collections/all"
                            className="group relative inline-flex h-16 items-center justify-center overflow-hidden rounded-full bg-white px-12 text-sm font-black uppercase tracking-widest text-black transition-all hover:bg-neutral-200 hover:scale-105 hover:shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)]"
                        >
                        ...
                        <Link
                            href="/sale"
                            className="group inline-flex h-16 items-center justify-center px-12 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm text-sm font-black uppercase tracking-widest text-white hover:bg-white/10 transition-all hover:scale-105"
                        >
                            Ver Ofertas
                        </Link>
                    </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="flex items-end justify-between mb-16 px-2">
                        <div>
                            ...
                            <h2 className="text-4xl md:text-6xl font-black text-white tracking-tighter">COLEÇÕES</h2>
                        </div>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[600px]">
                        {/* Major Item */}
                        <div className="md:col-span-8 md:row-span-2 relative group overflow-hidden rounded-3xl border border-white/10 bg-neutral-900">
                            ...
                            <div className="absolute inset-0 flex flex-col justify-end p-10 bg-gradient-to-t from-black/90 via-black/20 to-transparent">
                                <Trophy className="w-12 h-12 text-yellow-500 mb-6 drop-shadow-lg" />
                                <h3 className="text-5xl font-black uppercase italic tracking-tighter mb-2">Seleções</h3>
                                <p className="text-neutral-300 font-medium max-w-md text-lg">Os mantos sagrados das maiores potências do futebol mundial.</p>
                                <Link href="/collections/national-teams" className="absolute inset-0" />
                            </div>
                        </div>

                        {/* Secondary Item 1: Europa (Champions League Style) */}
                        <div className="md:col-span-4 md:row-span-1 relative group overflow-hidden rounded-3xl border border-white/10 bg-[#0e1628]">
                            ...
                            <div className="absolute inset-0 flex flex-col justify-between p-8 z-10">
                                <div>
                                    <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-blue-600/20 border border-blue-500/30 mb-4 backdrop-blur-md group-hover:scale-110 transition-transform duration-300">
                                        <Star className="w-6 h-6 text-blue-400 fill-blue-400/20" />
                                    </div>
                                    <h3 className="text-3xl font-black uppercase italic tracking-tighter text-white mb-1 drop-shadow-lg">
                                        Europa
                                    </h3>
                                    <p className="text-blue-200/60 font-medium text-sm tracking-wide">Champions League Elite</p>
                                </div>

                                <div className="flex justify-between items-end">
                                    <div className="h-1 w-12 bg-blue-500 rounded-full group-hover:w-24 transition-all duration-300" />
                                    <ArrowRight className="w-6 h-6 -rotate-45 group-hover:rotate-0 transition-transform text-white/50 group-hover:text-blue-400" />
                                </div>
                        ...
                        <div className="md:col-span-4 md:row-span-1 relative group overflow-hidden rounded-3xl border border-white/10 bg-[#0e2815]">
                            ...
                            <div className="absolute inset-0 flex flex-col justify-between p-8 z-10">
                                <div>
                                    ...
                                    <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-yellow-400/10 border border-yellow-400/30 mb-4 backdrop-blur-md group-hover:scale-110 transition-transform duration-300">
                                        {/* Abstract Shield Shape */}
                                        <svg viewBox="0 0 24 24" className="w-6 h-6 text-yellow-400 fill-yellow-400/20" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <p className="text-emerald-200/60 font-medium text-sm tracking-wide">O País do Futebol</p>
                                </div>
                                ...
                                <div className="flex justify-between items-end">
                                    ...
                                    <ArrowRight className="w-6 h-6 -rotate-45 group-hover:rotate-0 transition-transform text-white/50 group-hover:text-yellow-400" />
                                </div>
            ...
            <div className="w-full bg-primary py-4 overflow-hidden flex whitespace-nowrap">
                <div className="animate-marquee inline-flex gap-8 items-center text-black font-black uppercase tracking-widest text-sm">
                ...
                <div className="container mx-auto">
                    <div className="flex flex-col md:flex-row items-end justify-between gap-4 mb-16">
                        <div>
                            ...
                            <h2 className="text-4xl md:text-6xl font-black text-white tracking-tighter">LATEST DROPS</h2>
                        </div>
